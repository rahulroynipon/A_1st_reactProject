...
function PopUp({ Title, Click, setClick, Section }) {
  return (
    <main
      className={`${
        Click ? "flex" : "hidden"
    ...
    >
      <section className={`relative border pb-5 bg-white shadow rounded-lg`}>
        <button
        ...
        <div className="text-2xl font-bold px-5 pt-4 cursor-pointer">
          {Title}
        </div>
        {Section}
      </section>
